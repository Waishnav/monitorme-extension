...
async function typeIntoElement(element, value) {
  ...
  var _NightwatchStringifyExtension_instances, _NightwatchStringifyExtension_formatAsJSLiteral, _NightwatchStringifyExtension_appendStepType, _NightwatchStringifyExtension_appendNavigateStep, _NightwatchStringifyExtension_appendViewportStep, _NightwatchStringifyExtension_appendClickStep, _NightwatchStringifyExtension_appendChangeStep, _NightwatchStringifyExtension_appendKeyDownStep, _NightwatchStringifyExtension_appendKeyUpStep, _NightwatchStringifyExtension_appendScrollStep, _NightwatchStringifyExtension_appendDoubleClickStep, _NightwatchStringifyExtension_appendHoverStep, _NightwatchStringifyExtension_appendEmulateNetworkConditionsStep, _NightwatchStringifyExtension_appendWaitForElementStep, _NightwatchStringifyExtension_appendEndStep;
  class NightwatchStringifyExtension extends PuppeteerStringifyExtension {
      constructor() {
          super(...arguments);
          _NightwatchStringifyExtension_instances.add(this);
      }
      async beforeAllSteps(out, flow) {
          out.appendLine(`describe(${__classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_formatAsJSLiteral).call(this, flow.title)}, function () {`);
          out
              .appendLine(`it(${__classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_formatAsJSLiteral).call(this, `tests ${flow.title}`)}, function (browser) {`)
              .startBlock();
      }
      ...
      async stringifyStep(out, step, flow) {
          __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendStepType).call(this, out, step, flow);
      }
      getSelector(selectors, flow) {
          ...
          if (flow && flow.selectorAttribute) {
              preferredSelector = this.filterArrayByString(nonAriaSelectors, flow.selectorAttribute);
          }
          if (preferredSelector && preferredSelector[0]) {
              return `${__classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_formatAsJSLiteral).call(this, Array.isArray(preferredSelector[0])
                ? preferredSelector[0][0]
                : preferredSelector[0])}`;
          }
          else {
              return `${__classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_formatAsJSLiteral).call(this, Array.isArray(nonAriaSelectors[0])
                ? nonAriaSelectors[0][0]
                : nonAriaSelectors[0])}`;
          }
      }
      filterArrayByString(selectors, filterValue) {
          return selectors.filter((selector) => filterValue === 'aria/'
              ? !selector[0].includes(filterValue)
              : selector[0].includes(filterValue));
      }
      logStepsNotImplemented(step) {
          console.log(`Warning: Nightwatch Chrome Recorder does not handle migration of types ${step.type}.`);
      }
  }
  _NightwatchStringifyExtension_instances = new WeakSet(), _NightwatchStringifyExtension_formatAsJSLiteral = function _NightwatchStringifyExtension_formatAsJSLiteral(value) {
      return JSON.stringify(value);
  }, _NightwatchStringifyExtension_appendStepType = function _NightwatchStringifyExtension_appendStepType(out, step, flow) {
      switch (step.type) {
          case StepType.SetViewport:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendViewportStep).call(this, out, step);
          case StepType.Navigate:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendNavigateStep).call(this, out, step);
          case StepType.Click:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendClickStep).call(this, out, step, flow);
          case StepType.Change:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendChangeStep).call(this, out, step, flow);
          case StepType.KeyDown:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendKeyDownStep).call(this, out, step);
          case StepType.KeyUp:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendKeyUpStep).call(this, out, step);
          case StepType.Scroll:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendScrollStep).call(this, out, step, flow);
          case StepType.DoubleClick:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendDoubleClickStep).call(this, out, step, flow);
          case StepType.EmulateNetworkConditions:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendEmulateNetworkConditionsStep).call(this, out, step);
          case StepType.Hover:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendHoverStep).call(this, out, step, flow);
          case StepType.WaitForElement:
              return __classPrivateFieldGet(this, _NightwatchStringifyExtension_instances, "m", _NightwatchStringifyExtension_appendWaitForElementStep).call(this, out, step, flow);
          default:
      ...
      if (domSelector) {
          ...
          console.log(`Warning: The click on ${step.selectors} was not able to export to Nightwatch. Please adjust selectors and try again`);
      }
  }, _NightwatchStringifyExtension_appendChangeStep = function _NightwatchStringifyExtension_appendChangeStep(out, step, flow) {
      const domSelector = this.getSelector(step.selectors, flow);
      if (domSelector) {
  ...
  }, _NightwatchStringifyExtension_appendKeyDownStep = function _NightwatchStringifyExtension_appendKeyDownStep(out, step) {
  ...
  }, _NightwatchStringifyExtension_appendKeyUpStep = function _NightwatchStringifyExtension_appendKeyUpStep(out, step) {
      const pressedKey = step.key.toLowerCase();
      if (pressedKey in SupportedKeys) {
          const keyValue = SupportedKeys[pressedKey];
          out.appendLine(`.perform(function() {
  ...
  }, _NightwatchStringifyExtension_appendScrollStep = function _NightwatchStringifyExtension_appendScrollStep(out, step, flow) {
      if ('selectors' in step) {
          const domSelector = this.getSelector(step.selectors, flow);
      ...
      if (domSelector) {
          ...
          console.log(`Warning: The click on ${step.selectors} was not able to be exported to Nightwatch. Please adjust your selectors and try again.`);
      }
  }, _NightwatchStringifyExtension_appendHoverStep = function _NightwatchStringifyExtension_appendHoverStep(out, step, flow) {
      const domSelector = this.getSelector(step.selectors, flow);
      if (domSelector) {
          out.appendLine(`.moveToElement(${domSelector}, 0, 0)`);
      }
      else {
          console.log(`Warning: The Hover on ${step.selectors} was not able to be exported to Nightwatch. Please adjust your selectors and try again.`);
      }
  }, _NightwatchStringifyExtension_appendEmulateNetworkConditionsStep = function _NightwatchStringifyExtension_appendEmulateNetworkConditionsStep(out, step) {
      out.appendLine(`
    .setNetworkConditions({
      ...
      if (domSelector) {
          ...
          out.appendLine(`
      .waitForElementVisible(${domSelector}, ${step.timeout ? `${step.timeout}, ` : ''}function(result) {
        if (result.value) {
          ${assertionStatement}
        }
      })
      `);
          ...
          console.log(`Warning: The WaitForElement on ${step.selectors} was not able to be exported to Nightwatch. Please adjust your selectors and try again.`);
      }
  ...
  async function transformParsedRecording(parsedRecording) {
  ...
  async function nightwatchStringifyChromeRecording(recording) {
